...
### 2. ProjectE's persistent cron service
**Not applicable.** ProjectE has its own cron system with database-backed scheduling, but last30days is an open-source skill that should work without ProjectE. Could be an optional integration later.
