...
- [semantic/pattern_transcript_to_memory_synthesis.md](semantic/pattern_transcript_to_memory_synthesis.md) — Overnight synthesis of raw transcripts into tier-routed memory pages, with `≥3 motifs → pattern page` cross-file promotion. Adopted from GBrain v0.23.0 dream phase into /meditate Phase 0b/0c and /memory-consolidation Step 3.5.
