...
- [semantic/pattern_transcript_to_memory_synthesis.md](semantic/pattern_transcript_to_memory_synthesis.md) — Cross-file motif promotion (≥3 sources → pattern page) — surviving half of GBrain v0.23.0 dream-phase adoption. Transcript-synthesis half wa
