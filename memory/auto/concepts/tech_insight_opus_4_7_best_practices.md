...
Related: [advisor-strategy](tech_advisor_strategy.md) — Sonnet executor + Opus 4.7 advisor pattern still applies; [claude-code-routines](tech_claude_code_routines.md) — Routines default to 4.7 per Anthropic PM; [opus-for-investigation](feedback_opus_for_investigation.md) — now means 4.7 with xhigh default.
