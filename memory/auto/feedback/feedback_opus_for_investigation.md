...
Related: [opus-4-7-best-practices](concepts/tech_insight_opus_4_7_best_practices.md) — "Opus for investigation" now means 4.7 with xhigh default effort; subagent delegation requires explicit fan-out prompt (2026-04-16)
